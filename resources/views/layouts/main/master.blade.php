   ...
   <body class="home page-template page-template-page-blank page-template-page-blank-php page page-id-67 theme-flatsome woocommerce-no-js woo-variation-swatches wvs-theme-flatsome-child wvs-theme-child-flatsome wvs-style-rounded wvs-attr-behavior-blur wvs-tooltip wvs-css wvs-show-label wvs-pro lightbox nav-dropdown-has-arrow nav-dropdown-has-shadow nav-dropdown-has-border wvs-archive-align-left">
         ...
         <div class="sidebar-menu no-scrollbar ">
            <ul class="nav nav-sidebar nav-vertical nav-uppercase">
               ...
               <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-67 current_page_item menu-item-286"><a href="https://momilash.com/" aria-current="page">Home</a></li>
               <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-441">
                     ...
                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9076">
                        <a href="#">Eyelash Extensions</a>
                        <ul class="sub-menu nav-sidebar-ul">
                           <li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-9081"><a href="https://momilash.com/volume-eyelash-extensions/">Volume Eyelash Extensions</a></li>
                           <li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-9077"><a href="https://momilash.com/colored-eyelash-extensions/">Colored Eyelash Extensions</a></li>
                           <li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-9080"><a href="https://momilash.com/premade-fan-eyelash-extensions/">Pre-Made Fan Eyelash Extensions</a></li>
                           <li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-9079"><a href="https://momilash.com/mellow-eyelashes/">Mellow Eyelashes</a></li>
                           <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-9415"><a href="https://momilash.com/flare-eyelashes/">Flare Eyelashes</a></li>
                        </ul>
                     </li>
                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9082">
                        ...
                        <ul class="sub-menu nav-sidebar-ul">
                           <li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-9083"><a href="https://momilash.com/eyelash-glue-manufacturer/">Glue Collection</a></li>
                           <li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-9084"><a href="https://momilash.com/primer-collection/">Primer Collection</a></li>
                        </ul>
                     </li>
                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9085">
                        <a href="#">Remover Collection</a>
                        <ul class="sub-menu nav-sidebar-ul">
                           <li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-9086"><a href="https://momilash.com/cream-remover-pack/">Cream Remover Pack</a></li>
                           <li class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-9087"><a href="https://momilash.com/gel-remover-pack/">Gel Remover Pack</a></li>
                        </ul>
                     </li>
                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-9088"><a href="https://momilash.com/cleansing-collection/">Cleansing Collection</a></li>
                     <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-9589"><a href="https://momilash.com/other-liquid-products/">Other Liquid Products</a></li>
                     </ul>
               </li>
               <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-599"><a href="https://momilash.com/contact/">Contact</a></li>
               <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-532"><a href="https://momilash.com/about/">About Us</a></li>
               <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-9198">
                     <a href="#">More</a>
                     <ul class="sub-menu nav-sidebar-ul children">
                     <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9199"><a href="https://momilash.com/payment-methods/">Payment Methods</a></li>
                     <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9200"><a href="https://momilash.com/terms-and-conditions/">Terms and Conditions</a></li>
                     <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-privacy-policy menu-item-9202"><a href="https://momilash.com/privacy-policy/">Privacy Policy</a></li>
                     <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9203"><a href="https://momilash.com/faq/">FAQ</a></li>
                     <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-9204"><a href="https://momilash.com/blog/">Blog</a></li>
                     </ul>
               </li>
