    ...
    public function createOrEdit($request)
    {
        ...
        if($id){
            ...
            if($query){
                ...
                $query->curl = json_encode($request->curl);
                $query->length = json_encode($request->length);
                $query->line = json_encode($request->line);
                $query->thickness = json_encode($request->thickness);
                $query->color_product = json_encode($request->color_product);
